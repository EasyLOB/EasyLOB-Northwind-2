...
namespace Northwind.Mvc
{
    public partial class SupplierController : BaseMvcControllerSCRUDApplication<SupplierDTO, Supplier>
    {
        ...
        public ActionResult Index()
        {
            ...
            return View("OperationResult", new OperationResultViewModel(supplierCollectionModel.OperationResult));
        }        
        ...
        public ActionResult DataSource(DataManager dataManager)
        {
            ...
            if (IsSearch(operationResult))
            {
                try
                {
                    ...
                    dataResult.result = ZViewHelper<SupplierViewModel, SupplierDTO, Supplier>.ToViewList(Application.Select(operationResult, where, args.ToArray(), orderBy, dataManager.Skip, take));
