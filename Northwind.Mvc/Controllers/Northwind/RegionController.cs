...
namespace Northwind.Mvc
{
    public partial class RegionController : BaseMvcControllerSCRUDApplication<RegionDTO, Region>
    {
        ...
        public ActionResult Index()
        {
            ...
            return View("OperationResult", new OperationResultViewModel(regionCollectionModel.OperationResult));
        }        
                ...
                if (IsCreate(regionItemModel.OperationResult))
                {
                    if (IsValid(regionItemModel.OperationResult, regionItemModel.Region))
                    {
                        ...
                        if (Application.Create(regionItemModel.OperationResult, regionDTO))
                        {
                            ...
                            {
                                regionItemModel.OperationResult.InformationMessage =
        ...
        public ActionResult DataSource(DataManager dataManager)
        {
            ...
            if (IsSearch(operationResult))
            {
                try
                {
                    ...
                    dataResult.result = ZViewHelper<RegionViewModel, RegionDTO, Region>.ToViewList(Application.Search(operationResult, where, args.ToArray(), orderBy, dataManager.Skip, take));
