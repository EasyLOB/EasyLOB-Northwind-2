                ...
                if (IsCreate(categoryItemModel.OperationResult))
                {
                    if (IsValid(categoryItemModel.OperationResult, categoryItemModel.Category))
                    {
                        ...
                        if (Application.Create(categoryItemModel.OperationResult, categoryDTO))
                        {
                            ...
                            {
                                categoryItemModel.OperationResult.InformationMessage =
        ...
        public ActionResult DataSource(DataManager dataManager)
        {
            ...
            if (IsSearch(operationResult))
            {
                try
                {
                    ...
                    dataResult.result = ZViewHelper<CategoryViewModel, CategoryDTO, Category>.ToViewList(Application.Search(operationResult, where, args.ToArray(), orderBy, dataManager.Skip, take));
