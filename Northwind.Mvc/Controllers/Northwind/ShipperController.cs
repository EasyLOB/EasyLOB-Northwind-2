...
namespace Northwind.Mvc
{
    public partial class ShipperController : BaseMvcControllerSCRUDApplication<ShipperDTO, Shipper>
    {
        ...
        public ActionResult Index()
        {
            ...
            return View("OperationResult", new OperationResultViewModel(shipperCollectionModel.OperationResult));
        }        
                ...
                if (IsCreate(shipperItemModel.OperationResult))
                {
                    if (IsValid(shipperItemModel.OperationResult, shipperItemModel.Shipper))
                    {
                        ...
                        if (Application.Create(shipperItemModel.OperationResult, shipperDTO))
                        {
                            ...
                            {
                                shipperItemModel.OperationResult.InformationMessage =
                                    EasyLOB.Resources.PresentationResources.CreateToUpdate;
                                return JsonResultSuccess(shipperItemModel.OperationResult,
                                    Url.Action("Update", "Shipper", new { ShipperId = shipperDTO.ShipperId }, Request.Url.Scheme));
                            }
                            else
                            {
                                return JsonResultSuccess(shipperItemModel.OperationResult);
        ...
        public ActionResult DataSource(DataManager dataManager)
        {
            ...
            if (IsSearch(operationResult))
            {
                try
                {
                    ...
                    dataResult.result = ZViewHelper<ShipperViewModel, ShipperDTO, Shipper>.ToViewList(Application.Search(operationResult, where, args.ToArray(), orderBy, dataManager.Skip, take));
