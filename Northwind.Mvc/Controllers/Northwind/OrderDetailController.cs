...
namespace Northwind.Mvc
{
    public partial class OrderDetailController : BaseMvcControllerSCRUDApplication<OrderDetailDTO, OrderDetail>
    {
        ...
        public ActionResult Index(int? masterOrderId = null, int? masterProductId = null)
        {
            ...
            try
            {
                IsOperation(orderDetailCollectionModel.OperationResult);
            }
        ...
        public ActionResult DataSource(DataManager dataManager)
        {
            ...
            if (IsSearch(operationResult))
            {
                try
                {
                    ...
                    dataResult.result = ZViewHelper<OrderDetailViewModel, OrderDetailDTO, OrderDetail>.ToViewList(Application.Select(operationResult, where, args.ToArray(), orderBy, dataManager.Skip, take));
