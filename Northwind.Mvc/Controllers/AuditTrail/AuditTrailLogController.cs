...
namespace EasyLOB.AuditTrail.Mvc
{
    public partial class AuditTrailLogController : BaseMvcControllerSCRUDApplication<AuditTrailLogDTO, AuditTrailLog>
    {
        ...
        public ActionResult Index()
        {
            ...
            try
            {
                IsOperation(auditTrailLogCollectionModel.OperationResult);
            }
        ...
        public ActionResult DataSource(DataManager dataManager)
        {
            ...
            if (IsSearch(operationResult))
            {
                try
                {
                    ...
                    dataResult.result = ZViewHelper<AuditTrailLogViewModel, AuditTrailLogDTO, AuditTrailLog>.ToViewList(Application.Select(operationResult, where, args.ToArray(), orderBy, dataManager.Skip, take));
