        ...
        public ActionResult DataSource(DataManager dataManager)
        {
            ...
            if (IsSearch())
            {
                try
                {
                    ...
                    data = ZViewHelper<AuditTrailLogViewModel, AuditTrailLogDTO, AuditTrailLog>.ToViewList(Application.Select(operationResult, where, args.ToArray(), orderBy, dataManager.Skip, take));
