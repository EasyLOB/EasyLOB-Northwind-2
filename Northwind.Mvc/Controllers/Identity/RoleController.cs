...
namespace EasyLOB.Identity.Mvc
{
    public partial class RoleController : BaseMvcControllerSCRUDApplication<RoleDTO, Role>
    {
        ...
        public ActionResult Index()
        {
            ...
            return View("OperationResult", new OperationResultModel(roleCollectionModel.OperationResult));
        }        
                ...
                if (IsCreate(roleItemModel.OperationResult))
                {
                    if (IsValid(roleItemModel.OperationResult, roleItemModel.Role))
                    {
                        ...
                        if (Application.Create(roleItemModel.OperationResult, roleDTO))
                        {
                            ...
                            {
                                roleItemModel.OperationResult.InformationMessage =
        ...
        public ActionResult DataSource(DataManager dataManager)
        {
            ...
            if (IsSearch(operationResult))
            {
                try
                {
                    ...
                    dataResult.result = ZViewHelper<RoleViewModel, RoleDTO, Role>.ToViewList(Application.Search(operationResult, where, args.ToArray(), orderBy, dataManager.Skip, take));
