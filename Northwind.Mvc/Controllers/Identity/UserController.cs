        ...
        public ActionResult DataSource(DataManager dataManager)
        {
            ...
            if (IsSearch(operationResult))
            {
                try
                {
                    ...
                    dataResult.result = ZViewHelper<UserViewModel, UserDTO, User>.ToViewList(Application.Select(operationResult, where, args.ToArray(), orderBy, dataManager.Skip, take));
