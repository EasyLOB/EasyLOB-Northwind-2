...
namespace EasyLOB.Identity.Mvc
{
    public partial class UserRoleController : BaseMvcControllerSCRUDApplication<UserRoleDTO, UserRole>
    {
        ...
        public ActionResult Index(string masterRoleId = null, string masterUserId = null)
        {
            ...
            try
            {
                IsOperation(userRoleCollectionModel.OperationResult);
            }
        ...
        public ActionResult DataSource(DataManager dataManager)
        {
            ...
            if (IsSearch())
            {
                try
                {
                    ...
                    data = ZViewHelper<UserRoleViewModel, UserRoleDTO, UserRole>.ToViewList(Application.Select(operationResult, where, args.ToArray(), orderBy, dataManager.Skip, take));
